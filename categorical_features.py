...
reality_list = reality['SalePrice'].values.tolist()
print(reality_list)
print(predictions)
...
plt.plot(predictions,reality_list, 'ro')
...
def to_submit(pred_y,name_out):
    print("[INFO] Genarating output.csv")
    ...
    y_predict = y_predict.join(reality)
    y_predict.to_csv(name_out + '.csv',index=False)
    
to_submit(y_predict, "output")